...
*/
//
var imgOne = document.getElementById('img').src('img/img_one.webp');
var imgTwo = document.getElementById('img').src('img/img_two.webp');
var imgThree = document.getElementById('img').src('img/img_three.webp'); // Create a simple function that passes each page in as a parameter and returns it.

var btnBank = document.getElementByClassName('nav-item');
var homeBtn = document.getElementById('home-nav-button');
var aboutBtn = document.getElementById('about-nav-button');
var appBtn = document.getElementById('app-nav-button');
var contactBtn = document.getElementById('contact-nav-button');
var registerBtn = document.getElementById('register-nav-button');
homeBtn.click(function (pgHome) {
  return pgHome;
});
aboutBtn.click(function (pgAbout) {
  return pgAbout;
});
appBtn.click(function (pgApp) {
  return pgApp;
});
contactBtn.click(function (pgContact) {
  return pgContact;
});
registerBtn.click(function (pgRegister) {
  return pgRegister;
}); // This variable stores the HTML value for the HOME page.

var pgHome = document.getElementById('pgContent').innerHTML("\n\n  <div class=\"container\">\n\n    <img src=\"img/img_one.webp\" id=\"imgSwap\">\n\n    <div id=\"bullets\">\n      <a href=\"#\" onclick=\"changeImg(imgOne);\" id=\"bullet_one\"></a>\n      <a href=\"#\" onclick=\"changeImg(imgTwo);\" id=\"bullet_two\"></a>\n      <a href=\"#\" onclick=\"changeImg(imgThree);\" id=\"bullet_three\"></a>\n    </div>\n  </div>\n\n"); // This variable stores the HTML value for the ABOUT page.

var pgAbout = document.getElementById('pgContent').innerHTML("\n\n    <h1 class=\"develop\"> THE ABOUT PAGE IS BEING DEVELOPED...</h1>\n\n"); // This variable stores the HTML value for the THE APP page.

var pgApp = document.getElementById('pgContent').innerHTML("\n\n    <h1 class=\"develop\"> THE APP PAGE IS BEING DEVELOPED...</h1>\n\n"); // Create a simple function that passes each page in as a parameter and returns it.

var changePage = function changePage(page) {
  return page;
};

var changeImg = function changeImg(image) {
  return image;
};
